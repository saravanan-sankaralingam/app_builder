...
import { Loader2, LayoutGrid, Sparkles, LayoutTemplate, PenLine, ArrowLeft } from 'lucide-react'
  ...
  const creationMethods = [
    {
      ...
      iconColor: '#9333EA',
      title: 'Build with AI',
      description: 'Turn your ideas into a complete board in seconds.',
    },
    {
      id: 'template',
      icon: LayoutTemplate,
      ...
      iconColor: '#F59E0B',
      title: 'Templates',
      description: 'Install a board template from the template gallery',
    },
    {
      id: 'scratch',
      icon: PenLine,
      ...
      description: 'Build your board in the form editor.',
    },
  ]
        ...
        <DialogHeader>
          <div className="flex items-center gap-2">
            ...
            <DialogTitle className="text-base font-semibold">
              {step === 'method' ? 'How do you wish to create the Board?' : 'Create Board'}
            </DialogTitle>
          </div>
        </DialogHeader>
        ...
        {step === 'method' ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-5 mt-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="board-name" className="text-sm text-gray-600">
                Name
              </Label>
              <Input
                id="board-name"
            ...
            {/* Description */}
            <div className="space-y-2">
              <Label htmlFor="board-description" className="text-sm text-gray-600">

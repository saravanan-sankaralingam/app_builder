...
import { Loader2, Navigation, Sparkles, PenLine, ArrowLeft } from 'lucide-react'

interface NavigationCreateDialogProps {
  open: boolean
...
export function NavigationCreateDialog({
  open,
  onOpenChange,
  onSubmit,
  isLoading = false,
  ...
  const creationMethods = [
    {
      ...
      iconColor: '#9333EA',
      title: 'Build with AI',
      description: 'Turn your ideas into a complete navigation in seconds.',
    },
    {
      id: 'scratch',
      icon: PenLine,
      ...
      description: 'Build your navigation in the editor.',
    },
  ]
      ...
      <DialogContent className={cn(
        ...
        <DialogHeader>
          <div className="flex items-center gap-2">
            <div className="flex items-center justify-center w-7 h-7 rounded-md bg-pink-500">
              <Navigation className="h-4 w-4 text-white" />
            </div>
            <DialogTitle className="text-base font-semibold">
              {step === 'method' ? 'How do you wish to create the Navigation?' : 'Create Navigation'}
            </DialogTitle>
          </div>
        </DialogHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 mt-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Describe what this navigation is for"
                value={description}

...
import { Loader2, Workflow, Sparkles, LayoutTemplate, PenLine, ArrowLeft } from 'lucide-react'
  ...
  const creationMethods = [
    {
      ...
      iconColor: '#9333EA',
      title: 'Build with AI',
      description: 'Turn your ideas into a complete process in seconds.',
    },
    {
      id: 'template',
      icon: LayoutTemplate,
      ...
      iconColor: '#F59E0B',
      title: 'Templates',
      description: 'Install a process template from the template gallery',
    },
    {
      id: 'scratch',
      icon: PenLine,
      ...
      description: 'Build your process in the form editor.',
    },
  ]
        ...
        <DialogHeader>
          <div className="flex items-center gap-2">
            ...
            <DialogTitle className="text-base font-semibold">
              {step === 'method' ? 'How do you wish to create the Process?' : 'Create Process'}
            </DialogTitle>
          </div>
        </DialogHeader>
        ...
        {step === 'method' ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-5 mt-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="process-name" className="text-sm text-gray-600">
                Name
              </Label>
              <Input
                id="process-name"
            ...
            {/* Description */}
            <div className="space-y-2">
              <Label htmlFor="process-description" className="text-sm text-gray-600">
